 ...
 */
class Inchoo_KISSmetrics_Block_Event_Catalog_Category_Layered extends Mage_Core_Block_Template {

    protected function _construct() {
        parent::_construct();
        $this->setTemplate('inchoo/kissmetrics/event/catalog/category/layered.phtml');
    }
